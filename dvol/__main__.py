...
from dvol.dvol_helpers.compose_tools import enable_dvol, disable_dvol, manage_config
...
def main ():
    print ('dont ship', argparse.ArgumentParser)
    main = argparse.ArgumentParser(prog = 'dvol', description = cmd_main_desc)
    main.add_argument( "--version", "-v", action='version',  version = f'%(prog)s v{version}' )
